  ...
  return (
    <>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-sm  text-gray-400'>
        <h1 className='text-3xl mb-6'>Datenschutz&shy;erkl&auml;rung</h1>
        <h2 className='text-xl py-2 text-gray-900 font-bold'>
        ...
        <h4 className='text-base pt-4'>Wie erfassen wir Ihre Daten?</h4>{' '}
        <p className='mb-4'>
        ...
        <h4 className='text-base pt-4'>Wof&uuml;r nutzen wir Ihre Daten?</h4>{' '}
        <p className='mb-4'>
        ...
        <h2 className='text-xl py-2 text-gray-900 font-bold'>2. Hosting</h2>
        ...
        <p className='mb-4'>
          Telefon: +491709675488
          <br />
          E-Mail: galla@mutably.io
        </p>
        <p className='mb-4'>
