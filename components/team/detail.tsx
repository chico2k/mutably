  ...
  return (
    <ComponentWrapper>
      <div className='max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 '>
        ...
        <div className='space-y-12 sm:divide-y sm:divide-gray-200 sm:space-y-0 lg:gap-x-8 lg:space-y-0'>
                        ...
                        <div className='mt-2 flex'>
                          <p>
                            {detailData.languages.map((language, index) => (
                              <span
                                key={index}
                                className='inline-block bg-indigo-700 rounded-full px-3 py-1 text-xs font-semibold text-indigo-100 mr-2 mb-2'
                              >
                                {language}
                              </span>
                            ))}
