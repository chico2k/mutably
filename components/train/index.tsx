...
const TrainComponent = () => {
  return (
    <div className='max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 min-h-screen'>
      <div className='max-w-2xl mx-auto  lg:max-w-none'>
        ...
        <div className='grid grid-cols-1 items-center gap-y-10 gap-x-8 lg:grid-cols-3 lg:mt-12'>
